...
class APIManager: SessionManager {
    ...
    static let consumerKey = "bYM656e1YqrqAbSjOhzipPC7B"
    static let consumerSecret = "2OqzgLCWVSoEelIaCN9IWAB6NRAL1dyt7ePPmkjhcloD7bd5OI"
    ...
    func getNewHomeTimeLine(with tweetId: Int, completion: @escaping ([Tweet]?, Error?) -> ()) {
